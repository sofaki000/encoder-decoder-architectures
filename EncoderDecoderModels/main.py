...
import config
from EncoderDecoderModels.Pointer import PointerNetwork
from data_utilities import generate_data
from EncoderDecoderModels.EncoderDecoder import EncoderDecoderNetwork
from data_utilities.generate_data import task_data_for_predicting_same_sequence
from train import train, test

input_seq_len = 4
input, targets = generate_data.make_seq_data(config.train_size, input_seq_len) #task_data_for_predicting_same_sequence(config.train_size, input_seq_len)
